...
@REM by changing "SET csvfile=file1.txt" below.
...
imapsync ^
  --host1 imap.gmail.com --user1 %%G --password1 %%H ^
  --host2 suporte.shservidores21.com.br --user2 %%I --password2 %%J --syncinternaldates --ssl1 -ssl2 --noauthmd5 --split1 100 --split2 100 --port1 993 --port2 993 --exclude "All Mail|Spam|Trash" --allowsizemismatch
